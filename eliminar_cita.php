...
<body>
    ...
    <menu>
        <?php echo "<h2>Todas la citas del usuario: </h2>" .$_SESSION['nombres']; ?>
    </menu>
    <table class="tabla1">
        <tr class="color">
...
<tr>
                        ...
                        <?php $documento_medico= $datos->documento_medico;
                            ...
                            if(mysqli_num_rows($nombre_medico)>0){
                                ...
                                $_POST['apellido_medico']=$fila['apellidos'];
                            }else{
                                echo "no se encontro medico";
                            }
                        ?>
                        <td><?php echo $_POST['nombre_medico']; echo " "; echo $_POST['apellido_medico']?>
                        <td class="eliminar"><a href="eliminar.php ?id=<?php echo $datos->id_cita;?>">Cancelar</td>
                    </tr>
                <?php
            }
